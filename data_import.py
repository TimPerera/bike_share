...
# url ="https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/help_show?name=help_show"
...
# print(len(station_info['stations']))

# data = pd.DataFrame.from_dict(station_info['stations'])
